...
export default function Places() {
    return (
        ...
        <Navbar />
        <p className="m-10 text-2xl ">It is situated 19 km away from its sub-district Rahuri, 14 km Away From (M.P.K.V) Mahatma Phule Krishi Vidyapeeth and 25 km away from district Ahmednagar.
